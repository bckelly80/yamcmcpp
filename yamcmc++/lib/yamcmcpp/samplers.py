...
class MCMCSample(object):
    ...
    def plot_2dpdf(self, name, pindex1, pindex2):
        """
        Plot histograms of the parameter values generated by the MCMC sampler. If the parameter is array valued then
        histograms of all of the parameter's elements will be plotted.
        ...
        axJ.plot(traces[:,pindex1], traces[:,pindex2], 'ro', ms=1, alpha=0.5)  
        axX.hist(traces[:,pindex1], bins=100)
        axY.hist(traces[:,pindex2], orientation='horizontal', bins=100)
    ...
    def plot_2dkde(self, name, pindex1, pindex2, nbins=100, doPlotStragglers=True):
        """
        Plot histograms of the parameter values generated by the MCMC sampler. If the parameter is array valued then
        histograms of all of the parameter's elements will be plotted.
        ...
        traces = self._samples[name]    # Get the sampled parameter values
        npts   = traces.shape[0]
        trace1 = traces[:,pindex1].real # JIC we get something imaginary; make this more general
        trace2 = traces[:,pindex2].real
    ...
    def plot_autocorr(self, name, acorrFac = 10.0):
        """
